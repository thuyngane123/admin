...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả lớp học hệ thống.</p>
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            Danh sách Lớp Học
            <div class="float-end">
                <a href="AddLopHocServlet" class="btn btn-primary btn-sm">Thêm lớp học</a>
            </div>
        </div>
        <div class="card-body">
    ...
    <tr>
        <td><c:out value="${lopHoc.tenKhoaHoc}" /></td>
        <td><c:out value="${lopHoc.lopHoc}" /></td>
        <td><c:out value="${lopHoc.tenGiangVien}" /></td>
        <td><c:out value="${lopHoc.lichHoc}" /></td>
        <td>
           <c:choose>
              <c:when test="${lopHoc.trangThai eq 'Đang Mở'}"> 
        ...
        <td>
            <a href="UpdateLopHocServlet?action=edit&id=${lopHoc.id}" class="btn btn-sm btn-info">Sửa</a>
            <a href="DeleteLopHocServlet?action=delete&id=${lopHoc.id}" 
               onclick="return confirm('Bạn có chắc chắn muốn xóa lớp học ${lopHoc.lopHoc} không?')"
