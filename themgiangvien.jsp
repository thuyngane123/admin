    ...
    <div id="main">
        ...
        <div class="page-heading">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-body">
                        <!-- Form gửi dữ liệu POST đến NguoiDungServlet -->
                        <form action="${pageContext.request.contextPath}/AddGiangVienServlet" method="post">
    					<!-- Nếu là sửa thì có hidden input chứa id -->
    						<input type="hidden" name="id" value="${giangVien.id != null ? giangVien.id : 0}" />

    						<!-- Chọn người dùng (đã có trong bảng nguoi_dung, vai trò = giảng viên) -->
    						<div class="mb-3">
