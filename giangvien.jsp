                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả giảng viên hệ thống.</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-end">
						<a href="AddGiangVienServlet" class="btn btn-primary btn-sm">Thêm giảng viên</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                   <c:forEach var="gv" items="${listGV}">
										<tr>
    										...
    										<td>${gv.kinhNghiem}</td>
    										<td>
        										<a href="UpdateGiangVienServlet?action=edit&id=${gv.id}" class="btn btn-sm btn-info">Sửa</a> |
        										<a href="DeleteGiangVienServlet?id=${gv.id}"
   													onclick="return confirm('Bạn có chắc muốn xoá giảng viên này?');"
