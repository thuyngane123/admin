...
<body>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-end">
                <a href="AddDangKyHocServlet" class="btn btn-primary btn-sm">Đăng Ký Học</a>
            </div>
        </div>
        <div class="card-body">
            ...
            <tr>
                ...
                <td>
                    <a href="UpdateDangKyHocServlet?id=${dk.id}" class="btn btn-warning btn-sm">Sửa</a>
                    <a href="DeleteDangKyHocServlet?id=${dk.id}" class="btn btn-danger btn-sm"
                    onclick="return confirm('Bạn muốn xoá?');">Xoá</a>
                </td>
            </tr>
        </c:forEach>
                </tbody>
