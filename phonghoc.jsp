                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả các phòng học của trung tâm.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Quản lý Phòng Học</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            Danh sách Phòng Học
                            <div class="float-end">
						<a href="AddPhongHocServlet" class="btn btn-primary btn-sm">Thêm phòng học</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="phongHoc" items="${danhSachPhongHoc}">
                                        <tr>
                                           
                                            <td><c:out value="${phongHoc.tenPhong}" /></td>
                                          
                                            
                                            <td><c:out value="${phongHoc.siSo}" /></td>
                                         
                                            <td>
    											<c:choose>
        											<c:when test="${phongHoc.trangThai eq 'Đang sử dụng'}">
           												 <span class="badge bg-success">Đang sử dụng</span>
        											</c:when>

        											<c:when test="${phongHoc.trangThai eq 'Đang bảo trì'}">
                                            ...
                                            <td>
												<a href="UpdatePhongHocServlet?action=edit&id=${phongHoc.id}" class="btn btn-sm btn-info">Sửa</a>
    											<a href="DeletePhongHocServlet?action=delete&id=${phongHoc.id}" 
       												onclick="return confirm('Bạn có chắc chắn muốn xóa phòng học ${phongHoc.tenPhong} không?')"
