                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả học sinh hệ thống.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Quản lý Học Sinh</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            Danh sách Học Sinh
                            <div class="float-end">
						<a href="AddHocSinhServlet" class="btn btn-primary btn-sm">Thêm học sinh</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <c:forEach var="hocSinh" items="${danhSachHocSinh}">
                                        <tr>
                                            ...
                                            <td><c:out value="${hocSinh.hoTen}" /></td>
                                            ...
                                            <td><c:out value="${hocSinh.sdtPhuHuynh}" /></td>
                                            <td><c:out value="${hocSinh.hoTenPhuHuynh}" /></td>
                                         
                                            <td>
    											<c:choose>
        											<c:when test="${hocSinh.trangThai eq 'Đang học'}">
                                            ...
                                            <td>
												<a href="UpdateHocSinhServlet?action=edit&id=${hocSinh.id}" class="btn btn-sm btn-info">Sửa</a>
    											 <a href="${pageContext.request.contextPath}/DeleteHocSinhServlet?id=${hocSinh.id}" 
