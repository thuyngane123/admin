...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả buổi học hệ thống.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Quản lý buổi học</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-header">
            Danh sách Buổi Học
            <div class="float-end">
                <a href="AddBuoiHocServlet" class="btn btn-primary btn-sm">Thêm buổi học</a>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                   <c:forEach var="buoiHoc" items="${danhSachBuoiHoc}">
    <tr>
        <td><c:out value="${buoiHoc.lopHoc}" /></td>
        <td><c:out value="${buoiHoc.tenPhong}" /></td>
        <td><c:out value="${buoiHoc.thoiGianBatDau}" /></td>
        <td><c:out value="${buoiHoc.thoiGianKetThuc}" /></td>
        <td><c:out value="${buoiHoc.ngayHoc}" /></td>
      
        <td>
            <a href="UpdateBuoiHocServlet?action=edit&id=${buoiHoc.id}" class="btn btn-sm btn-info">Sửa</a>
            <a href="DeleteBuoiHocServlet?id=${buoiHoc.id}"
   				onclick="return confirm('Bạn có chắc muốn xóa buổi học này không?')"
