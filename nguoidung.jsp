                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Danh sách tất cả người dùng hệ thống.</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-end">
						<a href="AddNguoiDungServlet" class="btn btn-primary btn-sm">Thêm người dùng</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
									...
									<c:forEach var="nguoiDung" items="${danhSachNguoiDung}">
    									<tr>
									        <td><c:out value="${nguoiDung.tenDangNhap}" /></td>
        									...
        									<td>
    											<c:choose>
        											<c:when test="${nguoiDung.idVaiTro == 1}">Admin</c:when>
        											<c:when test="${nguoiDung.idVaiTro == 2}">Giảng viên</c:when>
        											<c:when test="${nguoiDung.idVaiTro == 3}">Học viên</c:when>
        									...
        									<td>
            									<c:choose>
               										 <c:when test="${nguoiDung.trangThai eq '1'}"> 
        										...
        										<td>
            										<a href="UpdateNguoiDungServlet?action=edit&id=${nguoiDung.id}" class="btn btn-sm btn-info">Sửa</a>
            										<a href="NguoiDungServlet?action=delete&id=${nguoiDung.id}" 
               												onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng ${nguoiDung.tenDangNhap} không?')"
